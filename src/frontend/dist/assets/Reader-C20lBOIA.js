import { e as useParams, i as useNavigate, a as useAuth, r as reactExports, j as jsxRuntimeExports, P as PageLoader, E as ErrorFallback, B as BookOpen, L as Link, h as Button, k as cn, m as LoaderCircle } from "./index-WeXjJ7Am.js";
import { u as useChapter } from "./useChapter-qP6IHLah.js";
import { u as useChapters } from "./useChapters-Aezclnad.js";
import { a as useSaveReadProgress } from "./useReadProgress-KuMmL7_w.js";
      ...
      children: [
        ...
        errored ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "opacity-50", children: [
              "⚠ Page ",
              index + 1,
              " unavailable"
            ] })
...
function ReaderPage() {
  ...
  const { mutate: saveProgress } = useSaveReadProgress(user == null ? void 0 : user.id);
  const published = (chapters == null ? void 0 : chapters.filter((c) => c.is_published).sort((a, b) => a.chapter_number - b.chapter_number)) ?? [];
  ...
  const { refetch: prefetchNext } = useChapter(
    ...
    (nextChapter == null ? void 0 : nextChapter.id) ?? void 0
  );
  ...
  const imageUrls = (chapter.pages ?? []).filter((p) => p != null).sort((a, b) => a.page_number - b.page_number).map((p) => p.image_url).filter((url) => typeof url === "string" && url.length > 0);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0 },
