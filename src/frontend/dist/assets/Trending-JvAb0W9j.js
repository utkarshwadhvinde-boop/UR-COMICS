import { u as useTrending, j as jsxRuntimeExports, F as Flame, L as Link } from "./index-yTllSx9S.js";
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full aspect-[9/14] overflow-hidden bg-purple-900/20", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-2 right-2 flex items-center gap-1 px-2 py-0.5 rounded-full bg-black/70 border border-orange-500/40", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body text-orange-300", children: hotScore.toFixed(0) })
              ] })
            ] }),
...
function TrendingPage() {
  ...
  const trendingComics = (trendingEntries ?? []).map((entry, idx) => {
    const comic = allComics == null ? void 0 : allComics.find((c) => c.id === entry.comic_id);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 sm:px-6 py-8", "data-ocid": "trending.page", children: [
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4", children: trendingComics.map(({ entry, comic, rank }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      TrendingCard,
      {
        comic,
        rank,
