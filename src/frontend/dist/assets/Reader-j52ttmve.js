import { c as createLucideIcon, r as reactExports, d as reactDomExports, j as jsxRuntimeExports, e as useComposedRefs, g as cn, h as useParams, i as useNavigate, u as useAppStore, k as getComicById, l as getChapterById, L as Link, a as Button, H as House, m as Heart, n as Sun, M as Moon, C as Coins, X } from "./index-BgVxhZ2x.js";
import { P as Primitive, c as createContextScope, u as useCallbackRef, a as useLayoutEffect2, b as useControllableState, d as useId, e as composeEventHandlers, f as createSlot } from "./index-DzUsK6bF.js";
import { u as useDirection, c as createCollection } from "./index-C_MDvkZv.js";
import { P as Portal$1, h as hideOthers, u as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer } from "./index-ClD3NfkI.js";
import { u as useSize, a as usePrevious, C as Check } from "./index-P7CI44_b.js";
import { C as ChevronDown, a as ChevronUp, T as ThumbsUp } from "./thumbs-up-CA4zvxxm.js";
...
function ComicPagePanel({
  ...
  const [from, to] = PANEL_PALETTES[index2 % PANEL_PALETTES.length];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
              inset: 0,
              backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 39px, rgba(255,255,255,0.03) 40px)",
              pointerEvents: "none"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center z-10 px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mt-3", style: { color: "rgba(255,255,255,0.3)" }, children: [
            title,
            " · ",
            chapter
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mt-1", style: { color: "rgba(255,255,255,0.2)" }, children: [
            "Page ",
            index2 + 1
          ] })
        ] })
...
function ReaderPage() {
  ...
  const chapter = reactExports.useMemo(
    () => (comic == null ? void 0 : comic.chapters.find((ch) => ch.id === chapterId)) ?? getChapterById(comicId, chapterId),
    [comic, comicId, chapterId]
  );
  const savedProgress = readingProgress.find((p) => p.comicId === comicId);
  const chapterIndex = (comic == null ? void 0 : comic.chapters.findIndex((ch) => ch.id === chapterId)) ?? 0;
  const prevChapter = comic == null ? void 0 : comic.chapters[chapterIndex - 1];
  const nextChapter = comic == null ? void 0 : comic.chapters[chapterIndex + 1];
  const isLiked = (currentUser == null ? void 0 : currentUser.likedComics.includes(comicId)) ?? false;
  const isBookmarked = (currentUser == null ? void 0 : currentUser.bookmarks.includes(comicId)) ?? false;
  const numPages = (chapter == null ? void 0 : chapter.pages.length) ?? 8;
  const readingMinutes = Math.max(1, Math.round(numPages * 0.5));
  const pageIndices = reactExports.useMemo(
    () => Array.from({ length: numPages }, (_, i) => i),
    [numPages]
  );
  const needsUnlock = (chapter == null ? void 0 : chapter.isPremium) && !isUnlocked && !((currentUser == null ? void 0 : currentUser.unlockedChapters.includes(chapterId)) ?? false);
  ...
  reactExports.useEffect(() => {
    if (savedScrollPos != null && scrollRef.current) {
      ...
      setTimeout(() => {
        var _a;
        (_a = scrollRef.current) == null ? void 0 : _a.scrollTo({ top: pos, behavior: "smooth" });
      }, 150);
    }
  }, [savedScrollPos]);
  ...
  reactExports.useEffect(() => {
    ...
    const onScroll = () => {
      ...
      setScrollPct(max2 > 0 ? Math.round(el.scrollTop / max2 * 100) : 0);
    };
  ...
  reactExports.useEffect(() => {
    const handler = (e) => {
      ...
      if (e.key === "ArrowDown") {
        (_a = scrollRef.current) == null ? void 0 : _a.scrollBy({ top: 200, behavior: "smooth" });
      } else if (e.key === "ArrowUp") {
        (_b = scrollRef.current) == null ? void 0 : _b.scrollBy({ top: -200, behavior: "smooth" });
  ...
  const handleUnlockWithCoins = () => {
    const cost = (chapter == null ? void 0 : chapter.coinCost) ?? 3;
  ...
  if (!comic || !chapter) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-[60vh] gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-foreground", children: "Chapter not found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", children: "Back to Home" }) })
    ] });
  }
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-2.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-white truncate leading-tight", children: comic.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-0.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "rgba(255,255,255,0.5)" }, children: chapter.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: "text-xs",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: isDarkMode ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "w-4 h-4 text-white/50" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "w-4 h-4 text-white/50" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Keyboard, { className: "w-4 h-4 text-white/40" })
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      ...
                      {
                        value: chapterId,
                        onValueChange: (val) => void navigate({
                          to: "/read/$comicId/$chapterId",
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: chapterOptions.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: opt.value, children: opt.label }, opt.value)) })
                        ]
                      }
                    ) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs", style: { color: "rgba(255,255,255,0.3)" }, children: [
                      chapterIndex + 1,
                      " / ",
              ...
              showKeyHints && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "bg-white/10 px-1 rounded text-white/60", children: "↑↓" }),
                      " ",
                      "Scroll"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "bg-white/10 px-1 rounded text-white/60", children: "n" }),
                      " ",
                      "Next chapter"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "bg-white/10 px-1 rounded text-white/60", children: "p" }),
                      " ",
                      "Prev chapter"
                    ] })
                  ]
          ...
          "div",
          {
            ...
            children: [
              needsUnlock ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-16 flex flex-col items-center gap-6 text-center", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-2xl space-y-1 opacity-30 pointer-events-none blur-sm", children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ComicPagePanel,
                  {
                    index: i,
                    title: comic.title,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto px-2 pt-4 space-y-1", children: pageIndices.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ComicPagePanel,
                  {
                    index: i,
                    title: comic.title,
                        ...
                        nextChapter ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                              ...
                              style: { color: "rgba(255,255,255,0.4)" },
                              children: "You've reached the latest chapter!"
                            }
                          ),
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onClick: () => {
                  var _a;
                  return (_a = scrollRef.current) == null ? void 0 : _a.scrollBy({ top: 300, behavior: "smooth" });
                },
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-5 h-5 text-white/70" })
              }
            )
          }
        ),
