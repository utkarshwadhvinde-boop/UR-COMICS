import { f as useParams, h as useNavigate, i as useActor, r as reactExports, j as jsxRuntimeExports, P as PageLoader, E as ErrorFallback, B as BookOpen, L as Link, e as Button, k as cn, l as LoaderCircle, m as createActor } from "./index-yTllSx9S.js";
import { u as useChapter } from "./useChapter-DD58udGS.js";
import { u as useChapters } from "./useChapters-BfU7OmAH.js";
import { a as useSaveReadProgress } from "./useReadProgress-CO_a3esw.js";
...
function ReaderPage() {
  ...
  if (actorFetching || isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {});
  if (isError)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ErrorFallback,
      {
  ...
  const imageUrls = chapter.image_blobs.filter((b) => b != null).map((b) => b.getDirectURL()).filter((url) => typeof url === "string" && url.length > 0);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0 },
