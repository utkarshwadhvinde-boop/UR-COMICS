import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, R as React, o as composeRefs, p as reactDomExports, q as useComposedRefs, t as ReactDOM, _ as __assign, v as __rest, w as __spreadArray, X, k as cn, T as TriangleAlert, h as Button, a as useAuth, n as useQueryClient, L as Link, E as ErrorFallback, B as BookOpen, x as deleteComic, y as ue } from "./index-WeXjJ7Am.js";
import { S as Skeleton } from "./skeleton-Dm3SSr1u.js";
import { B as Badge } from "./badge-C0UApj2x.js";
import { u as useComics, C as COMICS_QUERY_KEY } from "./useComics-CXCU-vzq.js";
import { u as useProfile } from "./useProfile-BMnjAJZv.js";
...
function ConfirmModal({
  ...
  const [remaining, setRemaining] = reactExports.useState(countdown);
  reactExports.useEffect(() => {
    if (!open) {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-1", children: [
            destructive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-destructive/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-4 h-4 text-destructive" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-foreground font-body", children: title })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-muted-foreground font-body", children: description })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "flex gap-2 sm:justify-end mt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              onClick: onConfirm,
              disabled: !canConfirm,
              className: destructive ? "" : "bg-accent text-accent-foreground hover:bg-accent/90",
              "data-ocid": "confirm.confirm_button",
              children: canConfirm ? confirmLabel : `${confirmLabel} (${remaining})`
            }
          )
        ] })
      ]
...
function CreatorDashboardPage() {
  ...
  const myComics = (comics == null ? void 0 : comics.filter((c) => userId && c.author_id === userId)) ?? [];
