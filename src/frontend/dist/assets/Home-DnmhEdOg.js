import { c as createLucideIcon, j as jsxRuntimeExports, S as Skeleton, u as useAppStore, r as reactExports, Z as Zap, B as BookOpen, L as Link, a as Button, f as formatNumber, T as TrendingUp, b as Badge } from "./index-BgVxhZ2x.js";
import { C as ComicCard } from "./ComicCard-DHybIGMg.js";
import { A as ALL_GENRES, G as GenreChip } from "./GenreChip-B8hw_Zr4.js";
import { P as Progress } from "./progress-up74YvoE.js";
import { F as Flame } from "./flame-BYSH-brk.js";
import { S as Star } from "./star-BZqe7TZP.js";
import { C as Clock, a as ChevronRight } from "./clock-CG0u3Osj.js";
...
function HomePage() {
  ...
  const trendingComics = [...comics].sort((a, b) => trendingScore(b) - trendingScore(a)).slice(0, 5);
  const popularThisWeek = [...comics].sort((a, b) => b.likes - a.likes).slice(0, 3);
  const recentlyUpdated = [...comics].sort((a, b) => b.updatedAt - a.updatedAt).slice(0, 6);
  const getRecommended = reactExports.useCallback(() => {
    const bookmarkedGenres = comics.filter((c) => readingProgress.some((p) => p.comicId === c.id)).flatMap((c) => c.genres);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-screen-xl mx-auto px-4 py-8 space-y-14", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              comics.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  to: "/read/$comicId/$chapterId",
                  params: {
                    comicId: ((_a = comics[0]) == null ? void 0 : _a.id) ?? "",
                    chapterId: ((_c = (_b = comics[0]) == null ? void 0 : _b.chapters[0]) == null ? void 0 : _c.id) ?? ""
                  },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "comics.section", children: [
        ...
        loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 mt-4", children: SKELETON_KEYS_10.map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonCard, {}, k)) }) : sorted.length === 0 ? (
      ...
      recentlyUpdated.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "recent.section", children: [
        ...
        loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4", children: SKELETON_KEYS_6.map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonRow, {}, k)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4", children: recentlyUpdated.map((comic, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ComicCard,
          {
            comic,
            index: i,
