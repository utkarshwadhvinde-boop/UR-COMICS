import { c as createLucideIcon, u as useTrending, a as useResumeReading, b as useAuth, r as reactExports, j as jsxRuntimeExports, B as BookOpen, L as Link, F as Flame, d as LogIn, e as Button, R as RefreshCw, E as ErrorFallback } from "./index-yTllSx9S.js";
import { S as SkeletonCardRow } from "./SkeletonCard-DZnBV3vF.js";
import { B as Badge } from "./badge-gMMAzD3C.js";
import { I as Input } from "./input-B8w6vewP.js";
import { u as useComics } from "./useComics-C6OQouxy.js";
import { u as useGenres, a as useSearchComics, b as useComicsByGenre } from "./useGenres-B8IUG2E8.js";
import { m as motion } from "./proxy-iTRpl-31.js";
import { S as Search } from "./search-BFBLR8Xz.js";
import { T as TrendingUp } from "./trending-up-_rSITLri.js";
...
function GenreRow({ genre }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10", "data-ocid": `genre.${genre.id}.section`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl text-foreground", children: genre.name }) }),
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 overflow-x-auto pb-2", children: [1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
      ...
      i
    )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 overflow-x-auto pb-2 scrollbar-hide", children: (comics ?? []).map((comic, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            ...
            params: { comicId: comic.id },
            className: "block",
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl overflow-hidden bg-card border border-border group-hover:border-accent/40 transition-smooth", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[3/4] overflow-hidden", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-2 left-0 right-0 flex justify-center opacity-0 group-hover:opacity-100 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-accent px-2.5 py-0.5 text-[10px] font-body font-semibold text-accent-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-2.5 h-2.5" }),
                  " Read"
                ] }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-foreground truncate leading-snug", children: comic.title }) })
            ] })
          }
        )
      },
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
                          ...
                          children: [
                            !isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "button",
                              {
                                ...
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(LogIn, { className: "w-6 h-6" }),
                                  "Sign In to Read Free"
                                ]
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 items-start", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                Button,
                                {
                                  asChild: true,
    ...
    genres && genres.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16",
        "data-ocid": "home.genres_section",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Grid3x3, { className: "w-5 h-5 text-accent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl text-foreground", children: "Browse by Genre" })
          ] }),
