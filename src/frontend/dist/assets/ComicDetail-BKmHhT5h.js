import { c as createLucideIcon, e as useParams, j as jsxRuntimeExports, E as ErrorFallback, L as Link, B as BookOpen, f as Layers, h as Button } from "./index-WeXjJ7Am.js";
import { B as Badge } from "./badge-C0UApj2x.js";
...
import { u as useReadProgress } from "./useReadProgress-KuMmL7_w.js";
...
import "./chaptersService-CdTVL-Cg.js";
        ...
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-10 h-10 rounded-lg bg-accent/10 border border-accent/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-display text-sm leading-none", children: chapter.chapter_number }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-foreground font-medium truncate group-hover:text-accent transition-smooth", children: chapter.title ?? `Chapter ${chapter.chapter_number}` }),
...
function ComicDetailPage() {
  ...
  const { data: progress } = useReadProgress(void 0, comicId);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", "data-ocid": "comic_detail.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          !comicLoading && (comic == null ? void 0 : comic.cover_url) && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-8 lg:gap-12", children: [
              comicLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-44 h-64 sm:w-52 sm:h-72 rounded-xl flex-shrink-0 bg-muted" }) : comic ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: comic.cover_url ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: comic.cover_url,
                      alt: comic.title,
                  ...
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-44 sm:w-52 aspect-[9/14] rounded-xl bg-muted/60 border border-border flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-12 h-12 text-muted-foreground" }) })
                }
              ) : null,
                ...
                motion.div,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 mt-2", children: [
                      (progress == null ? void 0 : progress.last_chapter_id) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          asChild: true,
                          size: "lg",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          ...
          !chaptersLoading && !chaptersError && publishedChapters.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: publishedChapters.map((ch, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ChapterRow,
            {
              chapter: ch,
              comicId,
