import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as BookOpen, f as Button, X, U as Upload, l as createActorWithConfig, E as ExternalBlob, m as createActor, k as useNavigate, n as useSearch, u as useAppStore, o as ChapterStatus, h as Badge, I as Input } from "./index-BU3WKumI.js";
import { A as ALL_GENRES, G as GenreChip } from "./GenreChip-CUEf3W-H.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-DT-hOwyc.js";
import { u as ue } from "./index-CPYKGEZc.js";
import { L as LoaderCircle } from "./loader-circle-UTANioOl.js";
import { C as CircleCheck, a as CircleAlert } from "./circle-check-aQ6nr6w0.js";
import { L as Label } from "./label-CT2dJsFT.js";
import { T as Textarea } from "./textarea-UOGAT82K.js";
import { d as useCreateComic, e as useUpdateComic, f as useCreateChapter, g as useUpdateChapter, h as usePublishChapter, u as useListChapters, i as isStoppedCanisterError } from "./useComicBackend-1k09e5r7.js";
import { E as Eye } from "./eye-DqdzshDN.js";
import { P as Plus } from "./plus-uQovYA7X.js";
import "./index-OcAYLIxh.js";
import "./index-j-azXTZT.js";
/**
...
async function getStorageFns() {
  ...
  try {
    const fns = await withTimeout(initPromise, 15e3, "Storage initialization");
...
function PageThumbnailRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: imageOrder.map((imgIdx, pos) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          draggable: !locked,
          ...
          className: `relative shrink-0 w-16 h-24 rounded-xl overflow-hidden border-2 transition-smooth ${locked ? "cursor-default border-border" : dragging === pos ? "opacity-40 border-primary cursor-grab" : over === pos ? "border-primary scale-105 cursor-grab" : "border-border cursor-grab"}`,
          ...
          children: [
            ...
            images[imgIdx].permanentUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
...
function PublishConfirmDialog({
  ...
  if (!open) return null;
  const isServiceDown = error !== null && (error.includes("is stopped") || error.includes("IC0508") || error.includes("temporarily unavailable") || error.includes("reject_code") && error.includes("5") && error.includes("stopped"));
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-3xl p-6 max-w-sm w-full shadow-lg animate-scale-in", children: [
        ...
        !isActorReady && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-4 text-sm text-muted-foreground", children: [
            ...
            children: [
              isServiceDown ? (
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-destructive/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-5 h-5 text-destructive" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-destructive mb-1", children: "Publishing service unavailable" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive/80 leading-relaxed", children: "The publishing service is temporarily unavailable. Please wait a moment and try again." })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
              ...
              !isServiceDown && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-spin w-4 h-4 border-2 border-primary-foreground/40 border-t-primary-foreground rounded-full" }) : !isActorReady ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-spin w-4 h-4 border-2 border-primary-foreground/40 border-t-primary-foreground rounded-full" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-4 h-4" }),
                isLoading ? "Publishing…" : !isActorReady ? "Loading…" : isServiceDown ? "Unavailable" : error ? "Retry Publish" : "Publish Now"
              ]
            }
          )
        ] })
...
function CreatePage() {
  ...
  async function uploadChapterImages(ch, _chapterIdx, comicBackendId, chapterBackendId, progressOffset, _totalImages, onProgress) {
    var _a2, _b2, _c2, _d2;
    if (chapterBackendId === null || chapterBackendId === void 0 || String(chapterBackendId).trim() === "" || String(chapterBackendId) === "new") {
      throw new Error(
    ...
    for (let imgIdx = 0; imgIdx < ch.images.length; imgIdx++) {
      ...
      console.info(
        `[Publish] Uploading image ${imgIdx + 1}/${ch.images.length} — path: "${uniqueName}", size: ${((_c2 = img.file) == null ? void 0 : _c2.size) ?? "unknown"} bytes, MIME: ${((_d2 = img.file) == null ? void 0 : _d2.type) || "(unknown)"}`
      );
      let fileToUpload;
      if (img.file) {
        try {
...
${reason}`
  ...
  const handlePublishConfirm = async () => {
    ...
    const failPublish = (step, err) => {
      ...
      const displayMsg = isServiceDown ? "Service temporarily unavailable — please try again in a moment." : rawMsg;
...
${displayMsg}`);
    ...
    try {
      ...
      for (const ch of chapters) {
        for (let imgIdx = 0; imgIdx < ch.images.length; imgIdx++) {
          const img = ch.images[imgIdx];
          const hasPermanent = img.permanentUrl && !img.permanentUrl.startsWith("blob:");
      ...
      for (const ch of chapters) {
        ...
        let chapterBackendId = ch.backendId ?? null;
        try {
          if (chapterBackendId === null || chapterBackendId === void 0) {
            const createdId = await createChapterMutation.mutateAsync(draftInput);
            if (createdId === null || createdId === void 0) {
              failPublish(
      ...
      for (let ci = 0; ci < chaptersWithIds.length; ci++) {
        ...
        const blobImages = uploadedImages.map((img, idx) => ({ img, idx })).filter(
          ({ img }) => !img.permanentUrl || img.permanentUrl.startsWith("blob:")
        );
      ...
      for (const ch of chaptersWithUploads) {
        ...
        const orderedUrls = ch.imageOrder.map((idx) => {
          ...
          const url = (img == null ? void 0 : img.permanentUrl) ?? (img == null ? void 0 : img.preview) ?? "";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  ...
                  !isActorReady ? "Loading..." : isPublishing ? "Publishing…" : existing ? "Publish Changes" : "Publish Comic"
                ]
              }
            )
          ] })
